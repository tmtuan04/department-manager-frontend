    ...
    <div className={`container-dn ${isSignUpActive ? "active" : ""}`} id="container">
      ...
      <div className="form-container sign-in">
        <form onSubmit={handleLogin}>
          ...
          <button onClick={loginWithGoogle} className="mt-3 p-3 google-login-btn active:scale-95 hover:scale-[1.02] font-medium flex justify-center items-center rounded-xl border-2 border-gray-200 py-2 gap-3">
              <svg
